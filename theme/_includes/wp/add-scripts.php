...
function load_scripts(){
	...
	//if (!is_admin()) {
		...
		wp_enqueue_script('jquery', get_template_directory_uri() . '/assets/js/vendor/jquery-3.7.1.min.js', array(), null, false);
	//}
	...
	wp_enqueue_script( 'slickjs', '//cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick.min.js', ['jquery'], null, false);
	...
	//wp_enqueue_script( 'scrollmagic', get_template_directory_uri() . '/assets/js/vendor/jquery.ScrollMagic.js', array( 'jquery' ), null, false );
		...
		wp_enqueue_script( 'main-js', get_template_directory_uri() . '/assets/js/main.js', ['jquery'], filemtime( get_template_directory_uri() . '/assets/js/main.js'), false);
